...
std::vector<ImuRecord> applyBiasCorrection(const std::vector<ImuRecord>& data, const Bias& bias)
{
    ...
    {
        ImuRecord corrected;
        corrected.x_gyro  = rec.x_gyro  - bias.x_gyro;
        corrected.y_gyro  = rec.y_gyro  - bias.y_gyro;
        corrected.z_gyro  = rec.z_gyro  - bias.z_gyro;
        corrected.x_accel = rec.x_accel - bias.x_accel;
        corrected.y_accel = rec.y_accel - bias.y_accel;
        corrected.z_accel = rec.z_accel - bias.z_accel;
